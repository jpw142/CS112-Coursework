...
class test {
    ...
    private static void mSort(int[] arr, int[] temp, int start, int end, int i) {
        if (start >= end) {
            return;
        }
        ...
        mSort(arr, temp, start, middle, i + 1);
        printArray(arr);
        System.out.println(i);
        mSort(arr, temp, middle + 1, end, i + 1);
    ...
    public static void mergeSort(int[] arr) {
        ...
        mSort(arr, temp, 0, arr.length - 1, 0);
    }
    ...
    public static void main(String[] arr) { 
        ...
        System.out.println(" ");
        mergeSort(new int[] {24, 3, 27, 13, 34, 2, 50, 12});
